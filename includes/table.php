...
if($rowCount > 0){
    while($row=mysqli_fetch_assoc($result)){
        ...
        echo '<tr>
                ...
                <td class="river_name">'.$row['nama'].'</a></td>
                <td class="location">'.$row['lokasi'].'</td>
                <td class="water_index"><a class="popup-button" onClick="showIndikator('.$row['id'].')"><i class="fa fa-info-circle" aria-hidden="true"></i></a> '.$wqiString.'</td>
